...
interface Category {
	...
	color: string
	percentage: number
	budgetAmount?: number // ✅ Добавляем это поле
}
...
export default function BudgetSetupPage() {
	...
	const [categories, setCategories] = useState<Category[]>(DEFAULT_CATEGORIES) // ✅ Указываем тип
			...
			<div className='container mx-auto px-4 max-w-3xl'>
				<Card>
					<CardHeader>
						...
						<CardDescription>Укажите общую сумму и распределите её по категориям</CardDescription>
					</CardHeader>
					<CardContent>
