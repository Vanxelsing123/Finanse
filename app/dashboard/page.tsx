...
import { formatCurrency, getCurrentMonthYear, getMonthName, calculatePercentage } from '@/lib/utils'
import { Plus, Wallet, TrendingUp, Target, ArrowRight } from 'lucide-react'
      ...
      <div className="container mx-auto px-4 py-6 space-y-6">
        ...
        <div className="flex justify-between items-center">
          <div>
            ...
            <p className="text-muted-foreground">Ваши финансы</p>
          </div>
          {!budget && (
        ...
        {budget ? (
            ...
            <div className="grid md:grid-cols-3 gap-4">
              <Card>
                <CardHeader className="pb-2">
                  <CardDescription>Всего бюджет</CardDescription>
              ...
              <Card>
                <CardHeader className="pb-2">
                  <CardDescription>Осталось</CardDescription>
          ...
          <Card>
            <CardHeader>
              <CardTitle>Начните с настройки бюджета</CardTitle>
              <CardDescription>
